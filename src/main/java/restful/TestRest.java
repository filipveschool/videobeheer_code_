...
public class TestRest {
    ...
    public static void main(String[] args) {
        ...
        //System.out.println("movie is : " + response2Metparameters);

         String themvdb = restTemplate.getForObject("https://api.themoviedb.org/3/movie/550?api_key=feb28e437be8a3b0b90f44da4bc93644", String.class);
        System.out.println("themvdb = " + themvdb);
